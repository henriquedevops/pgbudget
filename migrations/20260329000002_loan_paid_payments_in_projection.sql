...
-- Add paid loan payments (principal + interest) to the cash flow projection.
-- Previously, project_loan_amortization() skipped already-paid months, so
-- Jan-Mar 2026 payments for BV (Banco BV) were invisible in the report.
-- New branches 4c/4d surface historical paid payments from data.loan_payments.
...
-- +goose Down
-- +goose StatementBegin
SELECT 1; -- restore by re-running migration 20260322000002
-- +goose StatementEnd
